...
LightingMapsSpecular::LightingMapsSpecular():
...
void LightingMapsSpecular::initProgram()
{
...
void LightingMapsSpecular::onTouchBegan(float x, float y)
{
    m_lastX = x;
    m_lastY = y;
}

void LightingMapsSpecular::onTouchMove(float x, float y)
{
    if (m_firstMouse)
    {
        m_lastX = x;
...
void LightingMapsSpecular::onTouchEnd(float x, float y)
{
    
}

void LightingMapsSpecular::onMouseScroll(double x, double y)
{
    m_camera.ProcessMouseScroll(y);
}

void LightingMapsSpecular::onKeyPress(int key, int scancode, int action, int mods)
{
    if(key == GLFW_KEY_W)
    {
