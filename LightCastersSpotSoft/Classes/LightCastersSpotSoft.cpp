...
LightCastersSpotSoft::LightCastersSpotSoft():
...
void LightCastersSpotSoft::initProgram()
{
...
void LightCastersSpotSoft::render()
{
    ...
    m_lightingShader.getUniform("light.outerCutOff")->value1f(glm::cos(glm::radians(17.5f)));
...
void LightCastersSpotSoft::onTouchBegan(float x, float y)
{
    m_lastX = x;
    m_lastY = y;
}

void LightCastersSpotSoft::onTouchMove(float x, float y)
{
    if (m_firstMouse)
    {
        m_lastX = x;
...
void LightCastersSpotSoft::onTouchEnd(float x, float y)
{
    
}

void LightCastersSpotSoft::onMouseScroll(double x, double y)
{
    m_camera.ProcessMouseScroll(y);
}

void LightCastersSpotSoft::onKeyPress(int key, int scancode, int action, int mods)
{
    if(key == GLFW_KEY_W)
    {
